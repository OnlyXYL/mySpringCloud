...
import top.wikl.common.myenum.LabelType;
...
public class CypherResultUtil {
    ...
    public static ResultData dealwithResult(List<Record> greeting) {
        ArrayList<top.wikl.common.model.neo4j.Node> nodes = new ArrayList<>();
            ...
            if (keys.size() > 0) {
                ...
                for (String key : keys) {
                    ...
                    if ("NODE".equals(value_type)) {
                        ...
                        long id = node.id();
                        top.wikl.common.model.neo4j.Node node1 = new top.wikl.common.model.neo4j.Node();
                        //判断节点标签类型
